			...
			<form action="insertUser.do" method="post">
				<div class="modal-content">
					...
					<div class="modal-header">
						<h1 class="modal-title fs-5" id="staticBackdropLabel">사용자등록하기</h1>
					...
					<div class="modal-body">
						<div class="input-group mb-3">
							...
							<input type="text" name="id" class="form-control" id="id" required placeholder="id...">
						</div>
						<div class="input-group mb-3">
							<div class="input-group-text"><i class="fas fa-key"></i></div>
							<input type="password" name="password" class="form-control" id="password" required placeholder="pw...">
						</div>
						<div class="input-group mb-3">
							<div class="input-group-text"><i class="fas fa-user"></i></div>
