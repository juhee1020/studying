...
/*
	...
	인터페이스에도 상속이 가능하기 때문에 
	부모인터페이스에 디폴트메서드가 정의되어있는 경우
...
public class DefaultExtendsMain {
	public static void main(String[] args) {
		...
		ci1.method1(); ci1.method2(); ci1.method3();
		...
		ci2.method1(); ci2.method3();
		ci2.method2(); // ◀ 재정의됏음



		// 3. 디폴트메서드를 추상메서드로 재선언하는 방법.
		ChidInterface3 ci3= new ChidInterface3() {
			public void method1() {/*실행문*/}
			public void method2() {/*실행문*/}
			public void method3() {/*실행문*/}
		};
		ci3.method1(); ci3.method3();
