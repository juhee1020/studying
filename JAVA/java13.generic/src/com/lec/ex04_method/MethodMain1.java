...
public class MethodMain1 {
	...
	// 2. 일반메서드
		//Box 도구상자=Util.method("망치"); // method가 로봇만 받기 때문에 안됨?
		// Box 도구상자=Util.method(new Car()); // 에러
		Box 도구상자=Util.method(new Robot()); // 가능
...
class Robot {
	@Override
	public String toString() {return "나는 로봇입니다!";}
}

class Apple {
	@Override
	public String toString() {return "나는 사과입니다!";}
}

class Car {
	@Override
	public String toString() {return "나는 자동차입니다!";}
}