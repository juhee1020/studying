...
<!--
	...
	1. Action Tag
		...
		d. Java Beans(예를들어 BoardDTO, VO)등의 다양한 기능을 제공
	
	2. Action Tag의 종류
		
		a. jsp:forward : 다른페이지로 이동
		b. jsp:include
		c. jsp:useBean : JSP페이지에서 Java Bean 객체를 사용할 수 있도록 정의
		d. jsp:setProperty : Java Bean의 setter
		e. jsp:getProperty : Java Bean의 getter역할
		f. jsp:param : forward, include 등의 파라미터 지정
